...
(function(){
  var o = {
    ...
    (function() {
        var p = "4449417", n = JSON.parse('[]'), w = window, f = function(s) {
    ...
    var data = {
        params:window.ftParams_4449417||'',
        GUID:window.ftGUID_4449417||'99999999999',
        confID:window.ftConfID_4449417||'0',
        ftReturn: window.ftReturn_4449417||'',
        keyword:window.ftKeyword_4449417||'',
        ftId:window.ftId_4449417||'',
        imp:window.ftImp4449417,
        ftImpId:window.ftImp4449417 && window.ftImp4449417.impID || '',
        campaignID:'121994',
        cID:'119605',
        pID:'4449417',
        creativeID:'3004439',
        exttrack:["https://lciapi.ninthdecimal.com/v1/lci/imp/adv-smg/c-24174?typ=online&chn=ft&brand=lowes&iol=121994&plcmnt=4449417&crtv=3004439&site=[%FT_POSTAL%]&ord=[%FT_RANDOM%]&xdv=0&c1=dbm","https://d.agkn.com/pixel/4068/?che=[%random%]&col=121994,240,4449417,0,3004439,[%FT_IMPRESSIONID%],[%FT_GUID%]&puid=[%FT_GUID%]","https://aa.agkn.com/adscores/g.pixel?sid=9212273488&guid=[%FT_GUID%]"],
        extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=10900546&cmp=121994&sid=240&plc=267138755&num=&adid=&advid=775779&adsrv=29&region=30&btreg=267138755&btadsrv=flashtalking&crt=3004439&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src","https://cdn.krxd.net/controltag/r21vbr88k.js#campaignid=23791667&advertiserid=6545267&placementid=267138755&adid=462316727&creativeid=[%FT_CONFID%]&siteid=3381440&kxbrand=WTR&?[noCachebuster]"],
        clickTags: ["http://servedby.flashtalking.com/click/8/121994;4449417;3004439;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://d.agkn.com/pixel/4069/?che=[%random%]&col=121994,240,4449417,[%FT_CONFID%],3004439,[%FT_IMPRESSIONID%],[%FT_GUID%]&l1=https://www.lowes.com/l/gardencenter.html?cm_mmc=dis-_-c-_-lcl-_-wtr-_-3381440-_-267138755-_-0-_-0-_-0-_-0&","http://servedby.flashtalking.com/click/8/121994;4449417;3004439;212;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://d.agkn.com/pixel/4069/?che=[%random%]&col=121994,240,4449417,[%FT_CONFID%],3004439,[%FT_IMPRESSIONID%],[%FT_GUID%]&l1=https://www.lowes.com/store/?cm_mmc=dis-_-c-_-lcl-_-wtr-_-3381440-_-267138755-_-0-_-0-_-0-_-0&"],
        placementDescription:'BANGOOGLEDV360DISDSK1X1728X90FTOVPRG3PLWNHOMEOWNERSROASOFF92P18FPLH',
        width:728,
        height:90,
        ...
        divID:'ftdiv4449417',
        phID:'ftpos4449417',
        frameID:'ftframe4449417',
        expID:'ftexpframe4449417',
        altImgID:'ftalt4449417',
        altText:'Click here',
        altImgTarget:'_blank',
        altimghref:'http://servedby.flashtalking.com/click/8/121994;4449417;3004439;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://d.agkn.com/pixel/4069/?che=[%random%]&col=121994,240,4449417,[%FT_CONFID%],3004439,[%FT_IMPRESSIONID%],[%FT_GUID%]&l1=https://www.lowes.com/l/gardencenter.html?cm_mmc=dis-_-c-_-lcl-_-wtr-_-3381440-_-267138755-_-0-_-0-_-0-_-0&',
        altImg:'http://servedby.flashtalking.com/imp/8/121994;4449417;204;gif;Google;BANGOOGLEDV360DISDSK1X1728X90FTOVPRG3PLWNHOMEOWNERSROASOFF92P18FPLH/?',
        viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/121994;4449417;271;pixel;Google;BANGOOGLEDV360DISDSK1X1728X90FTOVPRG3PLWNHOMEOWNERSROASOFF92P18FPLH/?',
        stump:'http://servedby.flashtalking.com',
        jsurl:'http://cdn.flashtalking.com/xre/444/4449417/3004439/js/j-4449417-3004439.js',
        file:'http://cdn.flashtalking.com/119605/3004439/main.html',
        safeFrame: window.$sf && window.$sf.ext || false,
        serveDOM:'http://cdn.flashtalking.com',
        statBaseURL:'http://stat.flashtalking.com/reportV3/ft.stat?175774105-4449417;3004439;',
        adVis:false ? 1 : 0,
        centreAd:true,
        mvt:true,
        segment:window.ftSegment_4449417||'',
        segmentList:window.ftSegmentList_4449417||[],
        ...
        baggyFrameLimit:15,
        append:!!(window.ftImp4449417 && window.ftImp4449417.jsAppend),
        ...
        pageVisible: 'maybe',
        altimgborder: '0',
        secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m4449417')&&/^https:/.test(document.getElementById('ftscript_m4449417').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
        scriptLocation: document.getElementById('ftscript_m4449417'),
        ...
        qsVars:[
            ['ftguid', 'ftGUID_4449417'],
            ['ftcfid', 'ftConfID_4449417'],
            ['fttime', 'ftTimestamp_4449417'],
            ['ftsection', 'ftSection_4449417'],
            ['ftcustom', 'ftCustom_4449417'],
            ['ft_id', 'ftId_4449417'],
            ['ftimpid','ftImp4449417', 'impID']
        ]
    };
